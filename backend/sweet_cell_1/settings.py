"""
Django settings for sweet_cell_1 project.
...
ROOT_URLCONF = 'sweet_cell_1.urls'
...
WSGI_APPLICATION = 'sweet_cell_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "sweet_cell_1 API",
    "DESCRIPTION": "API documentation for sweet_cell_1 App",
    "VERSION": "v1",
}
